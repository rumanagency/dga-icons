...
const SafeDelivery02: IconNode = [
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M10 15c-1.655 0-2 .403-2 2.333v2.334C8 21.597 8.345 22 10 22h4c1.655 0 2-.403 2-2.333v-2.334c0-1.93-.345-2.333-2-2.333zM4 9c0-3.866 3.582-7 8-7s8 3.134 8 7z",
        "clipRule": "evenodd",
        "opacity": ".4"
      }
    ],
