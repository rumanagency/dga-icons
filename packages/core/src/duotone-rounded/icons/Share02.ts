...
const Share02: IconNode = [
    [
      ...
      {
        "fill": "currentColor",
        "d": "M15 4.999a3 3 0 1 1-5.958-.503 9.004 9.004 0 0 0-5.407 11.83 3 3 0 0 1 3.797 4.429A8.96 8.96 0 0 0 12 22a8.96 8.96 0 0 0 4.568-1.244 3 3 0 0 1 3.797-4.429 9.004 9.004 0 0 0-5.407-11.83Q15 4.741 15 5",
        "opacity": ".4"
      }
    ],
    [
