...
const LiveStreaming01: IconNode = [
    [
      ...
      {
        "fill": "currentColor",
        "d": "M17 20.5c1.87 0 2.8 0 3.5-.4.46-.27.84-.64 1.1-1.1.4-.7.4-1.63.4-3.5s0-2.8-.4-3.5c-.26-.46-.64-.83-1.1-1.1-.7-.4-1.63-.4-3.5-.4H7c-1.87 0-2.8 0-3.5.4-.46.27-.84.64-1.1 1.1-.4.7-.4 1.63-.4 3.5s0 2.8.4 3.5c.26.46.64.83 1.1 1.1.7.4 1.63.4 3.5.4z",
        "opacity": ".4"
      }
    ],
    [
