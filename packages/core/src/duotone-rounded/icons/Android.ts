...
const Android: IconNode = [
    [
      ...
      {
        "fill": "currentColor",
        "d": "M9.5 19h5c1.414 0 2.121 0 2.56-.44.44-.439.44-1.146.44-2.56v-6h-11v6c0 1.414 0 2.121.44 2.56.439.44 1.146.44 2.56.44",
        "opacity": ".4"
      }
    ],
    [
