...
const AddTeam: IconNode = [
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M8.5 11a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7m-4.643 9C2.831 20 2 19.233 2 18.286 2 15.919 4.079 14 6.643 14h3.714C12.922 14 15 15.919 15 18.286c0 .947-.83 1.714-1.857 1.714z",
        "clipRule": "evenodd",
        "opacity": ".4"
      }
    ],
