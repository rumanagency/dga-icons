...
const Slack: IconNode = [
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M7.5 14.75v5.5a1.75 1.75 0 1 0 3.5 0v-5.5a1.75 1.75 0 1 0-3.5 0m5.5-11v5.5a1.75 1.75 0 1 0 3.5 0v-5.5a1.75 1.75 0 1 0-3.5 0M14.75 13h5.5a1.75 1.75 0 1 1 0 3.5h-5.5a1.75 1.75 0 1 1 0-3.5m-5.5-5.5h-5.5a1.75 1.75 0 1 0 0 3.5h5.5a1.75 1.75 0 1 0 0-3.5",
        "clipRule": "evenodd",
        "opacity": ".4"
      }
    ],
