...
const UserBlock01: IconNode = [
    [
      ...
      {
        "fill": "currentColor",
        "d": "M5.095 15.759c.178-.101.342-.194.483-.277a10.66 10.66 0 0 1 11.002.091 3.5 3.5 0 0 0 .483 6.119 4.6 4.6 0 0 1-1.654.308H6.591c-1.546 0-2.775-.752-3.878-1.803-2.035-1.939.771-3.527 2.382-4.438",
        "opacity": ".4"
      }
    ],
    [
