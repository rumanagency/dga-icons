...
const Road02: IconNode = [
    [
      ...
      {
        "fill": "currentColor",
        "d": "M22 12c0 3.77 0 5.66-1.17 6.83S17.77 20 14 20h-4c-3.77 0-5.66 0-6.83-1.17S2 15.77 2 12s0-5.66 1.17-6.83S6.23 4 10 4h4c3.77 0 5.66 0 6.83 1.17S22 8.23 22 12",
        "opacity": ".4"
      }
    ],
    [
