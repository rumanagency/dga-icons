...
const SeatSelector: IconNode = [
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M11.5 2h1c2.828 0 4.243 0 5.121.879.879.878.879 2.293.879 5.121v2a1.5 1.5 0 0 0-1.5 1.5V14H7v-2.5A1.5 1.5 0 0 0 5.5 10V8c0-2.828 0-4.243.879-5.121C7.257 2 8.672 2 11.5 2m-2 20h5v-4h-5z",
        "clipRule": "evenodd",
        "opacity": ".4"
      }
    ],
