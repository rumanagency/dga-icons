...
const CapProjecting: IconNode = [
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M10 5h11v14H10c-2.809 0-4.213 0-5.222-.674a4 4 0 0 1-1.104-1.104C3 16.213 3 14.81 3 12s0-4.213.674-5.222a4 4 0 0 1 1.104-1.104C5.787 5 7.19 5 10 5m.5 9.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5",
        "clipRule": "evenodd",
        "opacity": ".4"
      }
    ],
