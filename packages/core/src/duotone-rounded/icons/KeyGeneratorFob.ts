...
const KeyGeneratorFob: IconNode = [
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M19 15a7 7 0 0 1-14 0c0-2.4.771-6.833 1.356-9.847.29-1.493.434-2.239.988-2.696S8.672 2 10.22 2h3.562c1.547 0 2.32 0 2.875.457.554.457.699 1.203.988 2.696C18.23 8.167 19 12.599 19 15m-7 4a4 4 0 1 0 0-8 4 4 0 0 0 0 8",
        "clipRule": "evenodd",
        "opacity": ".5"
      }
    ],
