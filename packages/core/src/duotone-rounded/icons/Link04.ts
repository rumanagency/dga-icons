...
const Link04: IconNode = [
    [
      ...
      {
        "fill": "currentColor",
        "d": "M9.999 9.117c-.918 1.478-.755 3.47.489 4.765a3.58 3.58 0 0 0 3.515 1 3.8 3.8 0 0 1-.49.629l-3.239 3.371q-.337.35-.73.59a3.58 3.58 0 0 1-4.471-.59c-1.43-1.49-1.43-3.904 0-5.394l3.24-3.371a3.6 3.6 0 0 1 1.686-1",
        "opacity": ".4"
      }
    ],
    [
