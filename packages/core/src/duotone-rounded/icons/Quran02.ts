...
const Quran02: IconNode = [
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M6 17h14.5V5.5A3.5 3.5 0 0 0 17 2H7a3.5 3.5 0 0 0-3.5 3.5v14A2.5 2.5 0 0 1 6 17m6-11.5 1.172 1.172h1.656v1.656L16 9.5l-1.172 1.172v1.656h-1.656L12 13.5l-1.172-1.172H9.172v-1.656L8 9.5l1.172-1.172V6.672h1.656z",
        "clipRule": "evenodd",
        "opacity": ".4"
      }
    ],
