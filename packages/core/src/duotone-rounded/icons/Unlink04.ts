...
const Unlink04: IconNode = [
    [
      ...
      {
        "fill": "currentColor",
        "d": "M9.997 9.117c-.917 1.478-.754 3.47.49 4.765a3.58 3.58 0 0 0 3.516 1 3.8 3.8 0 0 1-.49.629l-3.239 3.371q-.337.35-.73.59a3.58 3.58 0 0 1-4.471-.59c-1.43-1.49-1.43-3.905 0-5.394l3.24-3.372a3.6 3.6 0 0 1 1.684-.999",
        "opacity": ".4"
      }
    ],
    [
