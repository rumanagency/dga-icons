...
const Door02: IconNode = [
    [
      ...
      {
        "fill": "currentColor",
        "d": "M5 6v16h14V6c0-1.886 0-2.828-.586-3.414S16.886 2 15 2H9c-1.886 0-2.828 0-3.414.586S5 4.114 5 6",
        "opacity": ".4"
      }
    ],
    [
