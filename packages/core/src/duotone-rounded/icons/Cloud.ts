...
const Cloud: IconNode = [
    [
      ...
      {
        "fill": "currentColor",
        "d": "M17.5 9.5a5.5 5.5 0 0 0-10.98-.477A5 5 0 0 0 7 19h10.5a4.5 4.5 0 1 0 0-9h-.022q.021-.247.022-.5",
        "opacity": ".4"
      }
    ],
    [
