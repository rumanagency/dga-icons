...
const Line: IconNode = [
    [
      ...
      {
        "fill": "currentColor",
        "d": "M2 10.5C2 15.194 6.477 19 12 19q1.03-.001 2-.17V22c1.67-1.635 4.5-4.5 6.256-6.703C21.356 13.932 22 12.28 22 10.5 22 5.806 17.523 2 12 2S2 5.806 2 10.5",
        "opacity": ".4"
      }
    ],
    [
