...
const ArtboardTool: IconNode = [
    [
      ...
      {
        "fill": "currentColor",
        "d": "M15 7H9C7.4 7 7 8.333 7 9v6c0 3.3 0 4.95 1.025 5.975S10.7 22 14 22h1c3.3 0 4.95 0 5.975-1.025S22 18.3 22 15v-1c0-3.3 0-4.95-1.025-5.975S18.3 7 15 7",
        "opacity": ".4"
      }
    ],
    [
