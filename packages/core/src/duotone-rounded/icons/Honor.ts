...
const Honor: IconNode = [
    [
      ...
      {
        "fill": "currentColor",
        "d": "M4.5 13.999V3h15v10.999c0 2.329-.43 3.09-2.427 4.288l-3.015 1.808c-1.003.602-1.504.903-2.058.903s-1.055-.301-2.058-.903l-3.014-1.808C4.93 17.088 4.5 16.327 4.5 13.999",
        "opacity": ".4"
      }
    ],
    [
