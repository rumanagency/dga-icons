...
const CapStraight: IconNode = [
    [
      ...
      {
        "fill": "currentColor",
        "d": "M11.303 5H21v14h-9.697c-2.739 0-4.108 0-4.959-.879-.684-.707-.818-1.761-.844-3.621a2.5 2.5 0 0 0 0-5c.026-1.86.16-2.914.844-3.621C7.195 5 8.564 5 11.303 5",
        "opacity": ".4"
      }
    ],
    [
