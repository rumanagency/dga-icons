...
const Tree06: IconNode = [
    [
      ...
      {
        "fill": "currentColor",
        "d": "M9 18a3 3 0 0 1-3-3v-.035a3.5 3.5 0 0 1-.739-6.74A3 3 0 0 1 9.105 4.21a3.001 3.001 0 0 1 5.79.001 3 3 0 0 1 3.844 4.016 3.501 3.501 0 0 1-.74 6.739L18 15a3 3 0 0 1-3 3z",
        "opacity": ".4"
      }
    ],
    [
