...
const ElectricTower02: IconNode = [
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M5.5 20 7 14.5l1.5-5 3.5 2.059L15.5 9.5l1.5 5 1.5 5.5-6.5-3.109zm6.5-3.109 5-2.391-5-2.941L7 14.5zM9 7V2h6v5z",
        "clipRule": "evenodd",
        "opacity": ".4"
      }
    ],
