...
const RainDoubleDrop: IconNode = [
    [
      ...
      {
        "fill": "currentColor",
        "d": "M2 13.342c0-3.347 2.738-6.655 4.66-8.564 1.044-1.037 2.636-1.037 3.68 0C12.262 6.688 15 9.995 15 13.342 15 16.624 12.539 20 8.5 20S2 16.624 2 13.342",
        "opacity": ".4"
      }
    ],
    [
