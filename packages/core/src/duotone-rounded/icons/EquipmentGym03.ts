...
const EquipmentGym03: IconNode = [
    [
      ...
      {
        "fill": "currentColor",
        "d": "M7.277 19h9.447c1.237 0 1.856 0 2.112-.303.58-.686-.532-1.594-.938-2.051-.457-.516-.792-.646-1.468-.646H7.57c-.676 0-1.01.13-1.468.646-.406.457-1.518 1.365-.938 2.051C5.42 19 6.04 19 7.277 19",
        "opacity": ".4"
      }
    ],
    [
