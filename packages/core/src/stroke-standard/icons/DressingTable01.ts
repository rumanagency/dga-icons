...
const DressingTable01: IconNode = [
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M6.75 8a5.25 5.25 0 0 1 10.5 0v5.25H6.75zm-2.5 6.75V22a.75.75 0 0 0 1.5 0v-2.25h12.5V22a.75.75 0 0 0 1.5 0v-7.25H20a.75.75 0 0 0 0-1.5h-1.25V8a6.75 6.75 0 0 0-13.5 0v5.25H4a.75.75 0 0 0 0 1.5zm14 0v3.5H5.75v-3.5zm-6.72-9.22a.75.75 0 0 0-1.06-1.06l-1 1a.75.75 0 0 0 1.06 1.06zm2 1a.75.75 0 0 0-1.06-1.06l-2 2a.75.75 0 0 0 1.06 1.06zm-2.03 9.22a.75.75 0 0 0 0 1.5h1a.75.75 0 0 0 0-1.5z",
        "clipRule": "evenodd"
      }
    ]
  ];
