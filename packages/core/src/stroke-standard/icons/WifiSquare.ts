...
const WifiSquare: IconNode = [
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M1.75 4.5A2.75 2.75 0 0 1 4.5 1.75h15a2.75 2.75 0 0 1 2.75 2.75v15a2.75 2.75 0 0 1-2.75 2.75h-15a2.75 2.75 0 0 1-2.75-2.75zM4.5 3.25c-.69 0-1.25.56-1.25 1.25v15c0 .69.56 1.25 1.25 1.25h15c.69 0 1.25-.56 1.25-1.25v-15c0-.69-.56-1.25-1.25-1.25zm3.06 6.456a7.53 7.53 0 0 1 4.435-1.456c1.647 0 3.175.542 4.446 1.464a.75.75 0 0 1-.881 1.214 6.04 6.04 0 0 0-3.565-1.178 6.03 6.03 0 0 0-3.555 1.171.75.75 0 0 1-.88-1.215m1.903 2.632a5.2 5.2 0 0 1 2.532-.656c.916 0 1.78.24 2.543.662a.75.75 0 0 1-.727 1.312 3.7 3.7 0 0 0-1.816-.474c-.647 0-1.26.167-1.808.47a.75.75 0 0 1-.724-1.314M12 15a1 1 0 1 0 0 2h.006a1 1 0 0 0 0-2z",
        "clipRule": "evenodd"
      }
    ]
  ];
