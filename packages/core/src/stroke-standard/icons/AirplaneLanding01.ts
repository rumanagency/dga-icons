...
const AirplaneLanding01: IconNode = [
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M3.5 3.25a.75.75 0 0 0-.727.568l-1.5 5.985a.75.75 0 0 0 .485.892l5.45 1.86-1.675 1.333a.75.75 0 0 0 .252 1.305l5 1.497c.24.071.5.019.692-.14l2.177-1.795 5.538 1.89a1.932 1.932 0 0 0 2.558-1.826 7.245 7.245 0 0 0-6.482-7.198L7.66 6.808l-.417-2.914A.75.75 0 0 0 6.5 3.25zm-.605 6.249 1.19-4.749H5.85l.408 2.848a.75.75 0 0 0 .662.64l8.188.874a5.745 5.745 0 0 1 5.142 5.707c0 .293-.29.503-.573.407L13.742 13.2a.75.75 0 0 0-.719.132l-2.191 1.806-3.24-.97 1.624-1.292a.75.75 0 0 0-.224-1.297zM6 19.25a.75.75 0 0 0 0 1.5h16a.75.75 0 0 0 0-1.5z",
        "clipRule": "evenodd"
      }
    ]
  ];
