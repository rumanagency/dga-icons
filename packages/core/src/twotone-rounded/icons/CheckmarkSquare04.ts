...
const CheckmarkSquare04: IconNode = [
    ...
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M21.502 2.943a.75.75 0 0 1 .056 1.059l-9 10a.75.75 0 0 1-1.088.028l-3.5-3.5a.75.75 0 1 1 1.06-1.06l2.941 2.94 8.472-9.412a.75.75 0 0 1 1.059-.055",
        "clipRule": "evenodd",
        "opacity": ".4"
      }
    ]
