...
const Restaurant01: IconNode = [
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M9.678 4.741c.67-.368 1.128-.618 1.506-.782.364-.157.6-.209.816-.209s.452.052.816.21c.378.163.836.413 1.507.781l2.927 1.606V10a.75.75 0 0 0 1.5 0V7.17l.89.488a.75.75 0 0 0 .72-1.316L15.014 3.41c-.632-.347-1.152-.632-1.602-.827-.471-.203-.918-.332-1.41-.332-.494 0-.94.129-1.412.332-.45.195-.97.48-1.602.827L3.639 6.342a.75.75 0 1 0 .722 1.316l.889-.488V10a.75.75 0 0 0 1.5 0V6.347z",
        "clipRule": "evenodd"
      }
    ],
    [
