...
const Dua: IconNode = [
    ...
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M10.953 3.643a.75.75 0 0 0-.774-1.285 3.98 3.98 0 1 0 5.464 5.464.75.75 0 1 0-1.285-.775 2.48 2.48 0 1 1-3.405-3.405M14 3a1 1 0 1 0 0 2h.009a1 1 0 1 0 0-2z",
        "clipRule": "evenodd",
        "opacity": ".4"
      }
    ]
