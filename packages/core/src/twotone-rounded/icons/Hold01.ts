...
const Hold01: IconNode = [
    ...
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M11.75 3.5V10a.75.75 0 0 1-1.5 0V3.5a2.25 2.25 0 0 1 4.497-.12 2.25 2.25 0 0 1 3 2A2.25 2.25 0 0 1 20.75 7.5v6.193c0 1.065 0 1.9-.043 2.574-.044.687-.134 1.26-.338 1.793-.246.644-.842 1.376-1.24 1.83a1.45 1.45 0 0 0-.379.946V22a.75.75 0 0 1-1.5 0v-1.164c0-.736.296-1.415.751-1.934.412-.47.83-1.018.967-1.378.128-.332.203-.736.242-1.352.04-.622.04-1.409.04-2.505V7.5a.75.75 0 0 0-1.5 0V12a.75.75 0 0 1-1.5 0V5.5a.75.75 0 0 0-1.5 0V11a.75.75 0 0 1-1.5 0V3.5a.75.75 0 0 0-1.5 0",
        "clipRule": "evenodd"
      }
    ]
  ];
