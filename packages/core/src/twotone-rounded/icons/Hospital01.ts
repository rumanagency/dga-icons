...
const Hospital01: IconNode = [
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M14 10.75h2a.75.75 0 0 0 0-1.5h-2a.75.75 0 0 0 0 1.5m0 4h2a.75.75 0 0 0 0-1.5h-2a.75.75 0 0 0 0 1.5m-5 0H7a.75.75 0 0 1 0-1.5h2a.75.75 0 0 1 0 1.5m-2-4h2a.75.75 0 0 0 0-1.5H7a.75.75 0 0 0 0 1.5",
        "clipRule": "evenodd",
        "opacity": ".4"
      }
    ],
