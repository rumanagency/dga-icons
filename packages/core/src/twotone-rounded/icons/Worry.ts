...
const Worry: IconNode = [
    ...
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M8.794 16.002c.453-.336.935-.336 1.388 0l.269.2c.984.73 2.192.73 3.176 0l.27-.2c.452-.336.934-.336 1.387 0l.269.2a.75.75 0 1 0 .894-1.204l-.27-.2c-.983-.73-2.191-.73-3.175 0l-.27.2c-.452.336-.934.336-1.387 0l-.269-.2c-.984-.73-2.192-.73-3.176 0l-.347.258a.75.75 0 0 0 .894 1.204zM8 8a1 1 0 1 0 0 2h.009a1 1 0 1 0 0-2zm7.991 0a1 1 0 1 0 0 2H16a1 1 0 1 0 0-2z",
        "clipRule": "evenodd",
        "opacity": ".4"
      }
    ]
