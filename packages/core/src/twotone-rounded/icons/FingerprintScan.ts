...
const FingerprintScan: IconNode = [
    ...
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M12 5.75A5.25 5.25 0 0 0 6.75 11v4.5a.75.75 0 0 0 1.5 0V11a3.75 3.75 0 1 1 7.5 0v4.5a.75.75 0 0 0 1.5 0V11c0-2.9-2.35-5.25-5.25-5.25m0 3A2.25 2.25 0 0 0 9.75 11v5.5a.75.75 0 0 0 1.5 0V11a.75.75 0 0 1 1.5 0v1.5a.75.75 0 0 0 1.5 0V11A2.25 2.25 0 0 0 12 8.75m2.25 6.75a.75.75 0 0 0-1.5 0v2a.75.75 0 0 0 1.5 0z",
        "clipRule": "evenodd",
        "opacity": ".4"
      }
    ]
