...
const SignalLowMedium: IconNode = [
    ...
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M13.75 11a.75.75 0 0 0-1.5 0v8a.75.75 0 0 0 1.5 0zm-4 2a.75.75 0 0 0-1.5 0v6a.75.75 0 0 0 1.5 0zm6.5 6a.75.75 0 0 1 .75-.75h1a.75.75 0 0 1 0 1.5h-1a.75.75 0 0 1-.75-.75m4.75-.75a.75.75 0 0 0 0 1.5h1a.75.75 0 0 0 0-1.5z",
        "clipRule": "evenodd",
        "opacity": ".4"
      }
    ]
