...
const Clock04: IconNode = [
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M3.583 8.25C5.016 5.007 8.23 2.75 12 2.75a9.25 9.25 0 0 1 0 18.5.75.75 0 0 0 0 1.5c5.937 0 10.75-4.813 10.75-10.75S17.937 1.25 12 1.25c-4.818 0-8.847 3.168-10.216 7.525a.75.75 0 0 0 .716.975H5a.75.75 0 0 0 0-1.5z",
        "clipRule": "evenodd"
      }
    ],
    [
