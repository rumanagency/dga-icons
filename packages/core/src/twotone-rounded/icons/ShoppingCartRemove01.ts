...
const ShoppingCartRemove01: IconNode = [
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M9.97 2.47a.75.75 0 0 1 1.06 0l2.47 2.47 2.47-2.47a.75.75 0 1 1 1.06 1.06L14.56 6l2.47 2.47a.75.75 0 0 1-1.06 1.06L13.5 7.06l-2.47 2.47a.75.75 0 1 1-1.06-1.06L12.44 6 9.97 3.53a.75.75 0 0 1 0-1.06",
        "clipRule": "evenodd",
        "opacity": ".4"
      }
    ],
