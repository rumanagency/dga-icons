...
const Bitcoin03: IconNode = [
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M14 2.75a6.25 6.25 0 0 0-5.649 8.928.75.75 0 1 1-1.355.644 7.75 7.75 0 1 1 13.364 1.107.75.75 0 0 1-1.23-.858A6.25 6.25 0 0 0 14 2.75",
        "clipRule": "evenodd",
        "opacity": ".4"
      }
    ],
