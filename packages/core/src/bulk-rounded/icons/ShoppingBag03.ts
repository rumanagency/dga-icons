...
const ShoppingBag03: IconNode = [
    ...
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M12 3.125a3.296 3.296 0 0 0-3.287 3.061l-.215 3.01a1 1 0 0 1-1.995-.142l.215-3.01a5.296 5.296 0 0 1 10.564 0l.215 3.01a1 1 0 0 1-1.994.142l-.215-3.01A3.296 3.296 0 0 0 12 3.125",
        "clipRule": "evenodd"
      }
    ]
  ];
