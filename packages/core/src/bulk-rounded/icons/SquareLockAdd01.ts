...
const SquareLockAdd01: IconNode = [
    ...
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M10.5 3.25A3.5 3.5 0 0 0 7 6.75v1.56q-.49.018-.975.04A4.2 4.2 0 0 0 5 8.527V6.75a5.5 5.5 0 1 1 11 0v1.777a4.2 4.2 0 0 0-1.025-.177A93 93 0 0 0 14 8.31V6.75a3.5 3.5 0 0 0-3.5-3.5m7.75 10.5a1 1 0 1 0-2 0v3h-3a1 1 0 1 0 0 2h3v3a1 1 0 1 0 2 0v-3h3a1 1 0 1 0 0-2h-3z",
        "clipRule": "evenodd"
      }
    ]
  ];
