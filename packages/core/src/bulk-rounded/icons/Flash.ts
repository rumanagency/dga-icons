...
const Flash: IconNode = [
    ...
    [
      ...
      {
        "fill": "currentColor",
        "d": "M14.999 9.981H18.1c.886 0 1.496.598 1.747 1.226.25.626.217 1.431-.284 2.074l-6.998 8.983c-.562.72-1.444.895-2.173.585-.707-.301-1.19-1.016-1.19-1.87v-6.768l5.596-4.43c0 .11.09.2.2.2"
      }
    ]
  ];
