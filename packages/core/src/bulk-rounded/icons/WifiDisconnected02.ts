...
const WifiDisconnected02: IconNode = [
    ...
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M12 3c3.695 0 7.338 1.443 10.645 4.236a1 1 0 1 1-1.29 1.528C18.346 6.224 15.147 5 12 5S5.654 6.223 2.645 8.764a1 1 0 0 1-1.29-1.528C4.662 4.443 8.305 3 12 3m.087 6c2.59 0 5.094 1.14 7.141 3.314a1 1 0 0 1-1.456 1.372C16.052 11.859 14.056 11 12.087 11c-1.972 0-4.036.863-5.88 2.707a1 1 0 0 1-1.414-1.414C6.949 10.137 9.5 9 12.087 9",
        "clipRule": "evenodd",
        "opacity": ".4"
      }
    ]
