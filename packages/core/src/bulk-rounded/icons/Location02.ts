...
const Location02: IconNode = [
    ...
    [
      ...
      {
        "fill": "currentColor",
        "d": "M2.997 7.085C4.525 3.513 8.175 1.25 12.002 1.25v21.5a3.12 3.12 0 0 1-2.13-.835l-.001-.002c-.31-.293-.634-.591-.963-.896-1.73-1.6-3.646-3.372-4.96-5.357-1.603-2.423-2.373-5.251-.95-8.575"
      }
    ]
  ];
