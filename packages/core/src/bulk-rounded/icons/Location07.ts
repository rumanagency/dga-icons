...
const Location07: IconNode = [
    ...
    [
      ...
      {
        "fill": "currentColor",
        "d": "M2.25 10.926C2.25 5.61 6.725 1.25 12 1.25v21.5c-.454 0-.9-.117-1.296-.34l-.013-.008-.013-.008c-1.96-1.213-4.053-2.721-5.661-4.591-1.615-1.879-2.767-4.155-2.767-6.877"
      }
    ]
  ];
