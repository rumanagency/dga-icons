...
const SquareLockRemove02: IconNode = [
    ...
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M11 3.25a3.5 3.5 0 0 0-3.5 3.5v1.56q-.49.018-.975.04a4.2 4.2 0 0 0-1.025.177V6.75a5.5 5.5 0 1 1 11 0v1.777a4.2 4.2 0 0 0-1.025-.177 93 93 0 0 0-.975-.04V6.75a3.5 3.5 0 0 0-3.5-3.5M12.25 18a4.75 4.75 0 1 1 9.5 0 4.75 4.75 0 0 1-9.5 0m3.22-1.53a.75.75 0 0 1 1.06 0l.47.47.47-.47a.75.75 0 1 1 1.06 1.06l-.47.47.47.47a.75.75 0 1 1-1.06 1.06l-.47-.47-.47.47a.75.75 0 1 1-1.06-1.06l.469-.47-.47-.47a.75.75 0 0 1 .001-1.06",
        "clipRule": "evenodd"
      }
    ]
  ];
