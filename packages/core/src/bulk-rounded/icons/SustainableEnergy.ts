...
const SustainableEnergy: IconNode = [
    ...
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M13.074 6.18a1 1 0 0 1 .245 1.394L10.921 11H15a1 1 0 0 1 .82 1.573l-3.5 5a1 1 0 1 1-1.64-1.146L13.08 13H9a1 1 0 0 1-.82-1.573l3.5-5a1 1 0 0 1 1.393-.246",
        "clipRule": "evenodd"
      }
    ]
  ];
