...
const Necklace: IconNode = [
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M3 3.25a1 1 0 0 0-2 0c0 3.528 2.958 6.295 6.704 7.455a1 1 0 1 0 .592-1.91C4.978 7.767 3 5.537 3 3.25m20 0a1 1 0 1 0-2 0c0 2.287-1.978 4.517-5.296 5.545a1 1 0 1 0 .592 1.91C20.042 9.545 23 6.778 23 3.25",
        "clipRule": "evenodd",
        "opacity": ".4"
      }
    ],
