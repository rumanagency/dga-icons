...
const SquareLock02: IconNode = [
    ...
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M12 3.25a3.5 3.5 0 0 0-3.5 3.5v1.56q-.49.018-.975.04a4.2 4.2 0 0 0-1.025.177V6.75a5.5 5.5 0 1 1 11 0v1.777a4.2 4.2 0 0 0-1.025-.177 93 93 0 0 0-.975-.04V6.75a3.5 3.5 0 0 0-3.5-3.5m1 11.25a1 1 0 1 0-2 0v2a1 1 0 1 0 2 0z",
        "clipRule": "evenodd"
      }
    ]
  ];
