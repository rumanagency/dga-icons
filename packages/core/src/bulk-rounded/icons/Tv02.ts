...
const Tv02: IconNode = [
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M17.237 19.703q.68-.031 1.252-.108.447-.059.85-.157l.556 1.11a1 1 0 1 1-1.79.894zM4.66 19.438q.403.098.85.157.571.076 1.253.108l-.87 1.739a1 1 0 1 1-1.788-.894z",
        "clipRule": "evenodd"
      }
    ],
    [
