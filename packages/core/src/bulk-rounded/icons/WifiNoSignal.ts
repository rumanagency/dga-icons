...
const WifiNoSignal: IconNode = [
    ...
    [
      ...
      {
        "fill": "currentColor",
        "d": "M3.684 5.117A15.7 15.7 0 0 1 12 2.75v18.5c-.772 0-1.378-.386-1.929-.916-.527-.509-1.103-1.25-1.803-2.152L2.86 11.215c-.509-.656-.945-1.218-1.225-1.731-.305-.561-.463-1.132-.345-1.793.113-.632.406-1.095.844-1.497.388-.355.913-.681 1.5-1.045z"
      }
    ]
  ];
