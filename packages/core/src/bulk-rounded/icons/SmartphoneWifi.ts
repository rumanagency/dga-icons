...
const SmartphoneWifi: IconNode = [
    ...
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M14.993 1c-2.097 0-4.03.775-5.624 2.071a1 1 0 0 0 1.262 1.552C11.91 3.583 13.407 3 14.993 3c1.592 0 3.093.586 4.374 1.633a1 1 0 0 0 1.266-1.55C19.036 1.78 17.098 1 14.993 1M15 9a1 1 0 1 0 0 2h.006a1 1 0 1 0 0-2zm-3.246-2.855a6.1 6.1 0 0 1 3.24-.942 6.1 6.1 0 0 1 3.253.95 1 1 0 0 1-1.058 1.698 4.1 4.1 0 0 0-2.195-.648c-.774 0-1.514.225-2.186.641a1 1 0 0 1-1.054-1.7",
        "clipRule": "evenodd"
      }
    ]
  ];
