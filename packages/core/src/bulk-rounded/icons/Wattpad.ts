...
const Wattpad: IconNode = [
    ...
    [
      ...
      {
        "fill": "currentColor",
        "d": "M5.764 5.623c1.72.876 1.434 3.285 1.075 4.38C8.416 6.704 12.055 3.22 14 4.536c-1.5 1.465-2.598 6.18-3.397 8.754-3.764 9.856-8.066 7.118-9.141.548-1.076-6.571 2.15-9.31 4.302-8.214"
      }
    ]
  ];
