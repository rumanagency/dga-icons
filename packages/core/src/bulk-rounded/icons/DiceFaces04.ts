...
const DiceFaces04: IconNode = [
    ...
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M17.5 8a1.5 1.5 0 0 0-3 0v.01a1.5 1.5 0 0 0 3 0zm-8 8a1.5 1.5 0 0 0-3 0v.01a1.5 1.5 0 0 0 3 0zM8 6.5A1.5 1.5 0 0 1 9.5 8v.01a1.5 1.5 0 1 1-3 0V8A1.5 1.5 0 0 1 8 6.5m9.5 9.5a1.5 1.5 0 0 0-3 0v.01a1.5 1.5 0 0 0 3 0z",
        "clipRule": "evenodd"
      }
    ]
  ];
