...
const SchoolReportCard: IconNode = [
    ...
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M10.489 6.988A1.64 1.64 0 0 1 12 6c.644 0 1.249.375 1.512.988l2.407 5.618a1 1 0 1 1-1.838.788L13.484 12h-2.967l-.598 1.394a1 1 0 0 1-1.838-.788zM11.374 10h1.253L12 8.539zM8 16a1 1 0 1 0 0 2h8a1 1 0 1 0 0-2z",
        "clipRule": "evenodd"
      }
    ]
  ];
