...
const ChartIncrease: IconNode = [
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M6.5 16.5c0 .552.437 1 .975 1 3.073 0 5.94-.894 8.054-2.756 1.72-1.513 2.883-3.616 3.27-6.244h.924c.072 0 .213 0 .338-.018.108-.015.62-.099.851-.644s-.06-.986-.122-1.078a2.5 2.5 0 0 0-.232-.28l-.642-.704-.036-.04c-.26-.285-.518-.568-.76-.771-.274-.229-.652-.465-1.153-.465-.5 0-.878.236-1.152.465-.243.203-.5.486-.76.772l-.037.039-.642.704-.013.015c-.05.054-.147.16-.219.265-.062.092-.353.533-.122 1.078s.743.629.85.644c.126.019.267.018.34.018h.611c-.363 2.043-1.29 3.605-2.564 4.727-1.683 1.48-4.062 2.273-6.784 2.273a.99.99 0 0 0-.975 1",
        "clipRule": "evenodd",
        "opacity": ".4"
      }
    ],
