...
const Triangle: IconNode = [
    ...
    [
      ...
      {
        "fill": "currentColor",
        "d": "M19.067 8.864c1.243 1.995 2.207 3.54 2.828 4.796.622 1.26.965 2.352.823 3.415a5.4 5.4 0 0 1-1.856 3.411c-.817.693-1.918.983-3.302 1.123-1.381.14-3.186.14-5.514.14h-.091c-2.328 0-4.134 0-5.514-.14-1.384-.14-2.486-.43-3.302-1.123l14.26-14.26c.483.738 1.015 1.59 1.621 2.563z"
      }
    ]
  ];
