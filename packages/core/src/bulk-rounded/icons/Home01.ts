...
const Home01: IconNode = [
    ...
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M8.21 16.386a1 1 0 0 1 1.404-.175c.621.483 1.454.789 2.386.789s1.765-.306 2.386-.79a1 1 0 0 1 1.228 1.58C14.636 18.55 13.37 19 12 19s-2.636-.45-3.614-1.21a1 1 0 0 1-.175-1.404",
        "clipRule": "evenodd"
      }
    ]
  ];
