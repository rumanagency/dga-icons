...
const LocationFavourite01: IconNode = [
    ...
    [
      ...
      {
        "fill": "currentColor",
        "d": "M12 7.444c.65-.452 1.701-.7 2.837-.038.848.494 1.287 1.502 1.132 2.6-.156 1.107-.899 2.295-2.367 3.328-.466.33-.944.666-1.602.666s-1.136-.337-1.602-.666c-1.468-1.033-2.211-2.22-2.367-3.327-.155-1.099.284-2.107 1.132-2.601 1.136-.663 2.186-.414 2.837.038"
      }
    ]
  ];
