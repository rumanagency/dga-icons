...
const Nike: IconNode = [
    ...
    [
      ...
      {
        "fill": "currentColor",
        "d": "M2.811 17.348c-1.226-.68-1.594-2.036-1.559-3.346.036-1.331.48-2.831 1.136-4.173.654-1.34 1.557-2.6 2.576-3.415a.75.75 0 0 1 1.173.844c-.231.63-.425 1.34-.496 2.003-.074.68-.01 1.22.18 1.584.16.308.448.568 1.083.64.683.076 1.743-.076 3.325-.684 0 0-5.265 6.157-7.418 6.547"
      }
    ]
  ];
