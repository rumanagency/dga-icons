...
const Hexagon: IconNode = [
    ...
    [
      ...
      {
        "fill": "currentColor",
        "d": "M21.096 6.633c.348.618.505 1.279.58 2.063v6.61c-.075.784-.232 1.444-.58 2.063-.349.619-.83 1.09-1.458 1.552l-5.588 3.31c-.703.326-1.346.52-2.051.52s-1.348-.194-2.051-.52L4.36 18.92c-.628-.461-1.11-.933-1.458-1.552z"
      }
    ]
  ];
