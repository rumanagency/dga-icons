...
const WifiLocation: IconNode = [
    ...
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M11.995 7c-1.73 0-3.32.64-4.626 1.702a1 1 0 1 0 1.262 1.552C9.623 9.447 10.777 9 11.995 9c1.222 0 2.379.45 3.373 1.261a1 1 0 1 0 1.265-1.549C15.324 7.644 13.729 7 11.995 7m0 3.36c-.98 0-1.898.287-2.698.783a1 1 0 1 0 1.054 1.7 3.1 3.1 0 0 1 1.643-.484c.582 0 1.14.17 1.65.488a1 1 0 1 0 1.059-1.697 5.1 5.1 0 0 0-2.709-.79M11 15a1 1 0 0 1 1-1h.006a1 1 0 1 1 0 2H12a1 1 0 0 1-1-1",
        "clipRule": "evenodd"
      }
    ]
  ];
