...
const TextNumberSign: IconNode = [
    ...
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M22.2 4.05c-.35-.35-.878-.532-1.34-.637a7.5 7.5 0 0 0-1.61-.163c-.55 0-1.116.052-1.61.163-.462.105-.99.287-1.34.637s-.533.878-.636 1.34A7.5 7.5 0 0 0 15.5 7c0 .55.052 1.116.164 1.61.104.462.286.99.636 1.34s.878.533 1.34.636c.494.112 1.06.164 1.61.164s1.116-.052 1.61-.164c.462-.104.99-.286 1.34-.636s.533-.878.637-1.34A7.5 7.5 0 0 0 23 7a7.5 7.5 0 0 0-.163-1.61c-.104-.462-.287-.99-.637-1.34M16.5 12a1 1 0 1 0 0 2H22a1 1 0 1 0 0-2z",
        "clipRule": "evenodd"
      }
    ]
  ];
