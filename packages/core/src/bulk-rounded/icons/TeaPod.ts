...
const TeaPod: IconNode = [
    ...
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M18 9.422c.502.149.985.339 1.44.578q.288.15.557.327.003-.038.003-.077v-3.5a5.5 5.5 0 1 0-11 0v3.443a7.8 7.8 0 0 1 2-.833V6.75a3.5 3.5 0 1 1 7 0zm-4.5-.443a16 16 0 0 1 2 .013V7.5a1 1 0 1 0-2 0z",
        "clipRule": "evenodd"
      }
    ]
  ];
