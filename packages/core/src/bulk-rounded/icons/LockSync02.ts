...
const LockSync02: IconNode = [
    [
      "path",
      {
        "fill": "currentColor",
        "fillRule": "evenodd",
        "d": "M12 6.25c-1.638 0-3 1.298-3 2.94v1.458a4.1 4.1 0 0 0-1.25 2.944c0 2.315 1.922 4.158 4.25 4.158s4.25-1.843 4.25-4.158A4.1 4.1 0 0 0 15 10.648V9.19c0-1.643-1.362-2.941-3-2.941m1.5 3.452V9.19c0-.777-.652-1.441-1.5-1.441s-1.5.664-1.5 1.44v.512a4.3 4.3 0 0 1 1.5-.267c.527 0 1.033.094 1.5.267",
        "clipRule": "evenodd"
      }
    ],
    [
