...
const Pentagon: IconNode = [
    ...
    [
      ...
      {
        "fill": "currentColor",
        "d": "M21.203 7.37c.668.683 1.138 1.35 1.379 2.17.24.82.203 1.634.007 2.565l-2.473 7.477c-.425.918-.915 1.629-1.654 2.158-.994.713-2.193.94-3.31 1.01l-6.993-.127c-1.026-.114-1.882-.352-2.623-.883-.738-.529-1.228-1.24-1.653-2.158L18.386 5.078z"
      }
    ]
  ];
