...
const Zoom: IconNode = [
    ...
    [
      ...
      {
        "fill": "currentColor",
        "d": "m18.24 8.672.77-.768c1.594-1.589 2.392-2.384 3.066-2.096s.674 1.423.674 3.692v5.002c0 2.27 0 3.405-.674 3.693-.674.287-1.472-.507-3.066-2.097l-.77-.767c-.977-.973-.99-1.005-.99-2.394v-1.871c0-1.39.013-1.422.99-2.394",
        "opacity": ".4"
      }
    ]
  ];
